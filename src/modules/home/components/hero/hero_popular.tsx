    ...
    <section className="w-full py-8 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-black text-white shadow-md rounded-full w-10 h-10 flex items-center justify-center hover:bg-neutral-800 transition-colors"
          >
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="mt-2 text-center">
                  <h3 className="text-sm text-ui-fg-subtle group-hover:underline">
                    {product.title}
                  </h3>
                </div>
              </LocalizedClientLink>
